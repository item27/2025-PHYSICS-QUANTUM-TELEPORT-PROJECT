...
## 1) Подготовка запутанной пары (Alice/Bob)

**Смысл для пользователя:** Алиса или Боб готовит общую запутанную пару между собой.

**Что показываем визуально:**
- Кубиты Алисы и Боба получают «согласованную» фазу, чтобы выглядели связанными.
...
- Фаза у кубита Боба может немного смещаться, чтобы показать изменение.

**Формулы визуализации:**

$$
\varphi_{\text{Bob}} = \varphi_{\text{Alice}} + \frac{\pi}{3}
$$
...
$$
\theta_{\text{Bob}} = \theta_{\text{Alice (исходная)}}, \qquad
